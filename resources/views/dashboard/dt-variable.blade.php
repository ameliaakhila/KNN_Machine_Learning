...
@section('content')
    {{--! Komponen Tambah Data Variabel --}}
    <x-dtVariableCreate />

    {{--! Komponen Edit Data Variabel --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form
                                                ...
                                                action="{{ route('dataVariabel.destroy', $row->id) }}"
                                                method="POST"
                                            >
                                                @csrf
                                                @method('DELETE')

                                                <a class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#edit{{ $row->id }}">
